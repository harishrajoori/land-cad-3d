...
<div class="studio">
  ...
  <main>
    <aside>
      ...
      {#if model.valid && model.decisions.length}<div class="adapted" role="note"><strong>Adapted for this plot</strong><ul class="assumptions">{#each model.decisions as d}<li>{d}</li>{/each}</ul></div>{/if}
...
<style>
  ...
  .adapted{margin:12px 0;padding:10px 12px;background:#fbf3e2;border:1px solid #e6d3ac;border-radius:8px;font-size:10px;color:#6f5a2e}.adapted strong{display:block;margin-bottom:4px;font-size:11px}
