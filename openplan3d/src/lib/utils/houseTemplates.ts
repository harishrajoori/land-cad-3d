...
const baseTemplates: HouseTemplate[] = [
  {
...
// Vaastu G+1 templates for the real Karimnagar properties are appended after the
// generic ones so they show up together in the template picker.
import { vaastuTemplates } from './vaastuTemplates';

export const houseTemplates: HouseTemplate[] = [...vaastuTemplates, ...baseTemplates];
